...
public class EditListerProfileFragment extends Fragment {
    ...
    public View onCreateView(@Nullable LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_edit_lister_profile, container, false);
    }
        ...
        mDatabaseRef.child("listers").child(mFirebaseUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    lister = dataSnapshot.getValue(Lister.class);
                    Glide.with(imageView.getContext())
                            .load(lister.getPicUrl())
                            .into(imageView);
                    firstnameEditText.setText(lister.getFirstname());
    ...
    private void updateListerWithNewImage(final StorageReference storageReference, final String firstname, final String lastname, final String email, final String phoneNumber, final String city, final String state, final String key) {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri downloadPhotoUrl) {
                        mDatabase.getReference("listers").child(key).setValue(new Lister(firstname, lastname, email, phoneNumber, city, state, downloadPhotoUrl.toString()));
                    }
                });
            }
        });
